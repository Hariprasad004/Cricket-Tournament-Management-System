 ...
 * @author Hariprasad
 */
public class Run_Search extends javax.swing.JFrame {
    static String s;
    /**
     * Creates new form Run_Search
     */
    public Run_Search() {
        initComponents();
        setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("logo.jpeg")));
        ConfigureFrame.ConfigureFrame(this,"Most Runs Search",1);
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setBounds(180, 260, 400, 50);
        ...
        jButton1.setBounds(280, 360, 180, 40);
        ...
        jScrollPane1.setBounds(620, 100, 1280, 402);
        ...
        jRadioButtonMenuItem1.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        ...
        jRadioButtonMenuItem2.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        ...
        jRadioButtonMenuItem3.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        ...
        jRadioButtonMenuItem4.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        ...
        jRadioButtonMenuItem5.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        ...
        jRadioButtonMenuItem6.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       Operation.CallableExecute(sql);
        ...
        if(var.getText().equals("Enter the Player Name")){
            SQL = "SELECT *from RPosition where Player='"+s+"'";
        }
        else if(var.getText().equals("Enter Team Name")){
            SQL = "SELECT *from RPosition where Team='"+s+"'";
        }
        else if(var.getText().equals("Enter the Position")){
            int I=Integer.parseInt(s);
            SQL = "SELECT *from RPosition where Position="+I;
        }
        else {
    ...
    public static void main(String args[]) {
       s=args[0];
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Run_Search.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Run_Search().setVisible(true);
            }
        });
    }
