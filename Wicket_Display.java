...
import static miniprjct.Match_Display.s;

/**
 *
 * @author Hariprasad
 */
public class Wicket_Display extends javax.swing.JFrame {
    static String s= new String();
    /**
     * Creates new form Wicket_Display
     */
    public Wicket_Display() {
        initComponents();
        setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("logo.jpeg")));
        ConfigureFrame.ConfigureFrame(this,"Wickets Display",1);
         String sql="{call TWickets()}";
       Operation.CallableExecute(sql);
        String SQL="Select *from WPosition";
        try {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(810, 520, 240, 50);
        ...
        jScrollPane1.setBounds(310, 70, 1290, 402);

        jLabel1.setIcon(new javax.swing.ImageIcon("E:\\Cricket\\cri2.jpeg")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Wicket_Display.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Wicket_Display().setVisible(true);
            }
        });
    }
