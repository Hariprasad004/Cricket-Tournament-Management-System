...
public class Team_Delete extends javax.swing.JFrame {
    ...
    public Team_Delete() {
        ...
        ConfigureFrame.ConfigureFrame(this,"Team Delete",1);
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(-1570, -1280, 3860, 2320);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String sql="Delete from TEAMS where Player='"+player.getText().trim()+"'and T_Name='"+team.getText().trim()+"'";
